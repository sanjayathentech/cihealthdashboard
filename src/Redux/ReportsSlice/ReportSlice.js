...
export const ReportSlice = createSlice({
    ...
    reducers: {
        setSelectedResourceType: (state, action) => {
            ...
            state.Resources = state.ResourceTypes.find((x) => x.resourceTypeFriendlyName === action.payload).resources
        },
    ...
    extraReducers(builder) {
        builder
            .addCase(GetAllresourcesandResourcetype.fulfilled, (state, { payload }) => {
                ...
                state.Resources = payload.data.find((x) => x.resourceTypeFriendlyName === payload.selectId).resources
            })
